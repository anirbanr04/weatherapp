...
if(temp>=29){
    ...
    let img="..//Weather app/weather-app-img/images/clear.png"
    imageicon.src=img;
}
if(temp>=20&&temp<29){
    let imageicon=document.querySelector(".imageicon img");
    let imgs="..//Weather app/weather-app-img/images/clouds.png"
    imageicon.src=imgs;
}
if(temp<20){
    let imageicon=document.querySelector(".imageicon img");
    let imgg="..//Weather app/weather-app-img/images/snow.png"
    imageicon.src=imgg;
}
